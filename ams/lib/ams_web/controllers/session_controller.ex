defmodule AmsWeb.SessionController do
  use AmsWeb, :controller
  alias Ams.{Accounts, Accounts.User, Accounts.Guardian}
  ...
  defp login_reply({:ok, user}, conn) do
    ...
    |> redirect(to: "/admin")   #and the arguments specified in the Guardian.Plug.sign_in()
  end
  #docs are not applicable here.
