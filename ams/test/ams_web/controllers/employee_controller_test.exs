defmodule AmsWeb.EmployeeControllerTest do
  use AmsWeb.ConnCase

  alias Ams.Payroll

  @create_attrs %{current_designation: "some current_designation", current_salary: 120.5, email: "some email", joining_date: ~D[2010-04-17], name: "some name"}
  ...
  describe "update employee" do
    ...
    test "redirects when data is valid", %{conn: conn, employee: employee} do
      ...
      assert html_response(conn, 200) =~ "some updated current_designation"
    end
